...
class Migration(migrations.Migration):
    ...
    replaces = [('talentpool', '0001_initial'), ('talentpool', '0002_alter_jobadvert_uuid_alter_jobapplication_uuid_and_more')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', talentpool.apps.UUIDAutoField(default=uuid.uuid4, editable=False, primary_key=True, unique=True)),
